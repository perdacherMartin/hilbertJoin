...
- [Super-EGO](https://www.ics.uci.edu/~dvk/code/SuperEGO.html).   Notes: we adapted the code to perform a self-join and added efficient thread-independent counting.
